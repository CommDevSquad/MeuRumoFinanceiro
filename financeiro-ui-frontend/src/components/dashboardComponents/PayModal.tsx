      ...
      <div className="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl p-6 transition-colors">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Pagar Conta</h2>
          </div>
          <button 
            onClick={onClose}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-12 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-400 transition-colors"
                required
              />
              <button
                type="button"
              ...
              >
                <Scan className="w-5 h-5 text-gray-600 dark:text-gray-300" />
              </button>
            </div>
          </div>
