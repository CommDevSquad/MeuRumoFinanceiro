        ...
        return (
            <div className="min-h-screen flex items-center justify-center px-4 py-8">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl text-center transition-colors">
        ...
        <main className="flex flex-col items-center justify-center min-h-screen bg-[var(--color-blue-50)] dark:bg-transparent py-[40px] transition-colors">
            <div className="flex flex-col items-center justify-center">
                <div className="flex flex-col items-center justify-center mb-[30px]">
                    ...
                    <p className="text-[var(--color-gray-700)] dark:text-gray-300">Recupere o acesso à sua conta</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-300">ou</span>
                            </div>
                        </div>
